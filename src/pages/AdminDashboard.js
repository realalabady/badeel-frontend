...
import { BarChart, Users, GraduationCap, CheckCircle, FileText, BookOpen } from "lucide-react";
...
export default function AdminDashboard() {
  ...
  const sidebarItems = [
    ...
    { icon: BookOpen, label: "الجلسات", onClick: () => navigate("/assignments") },
    { icon: Users, label: "المستخدمين", onClick: () => {} }
  ];
    ...
    <DashboardLayout user={user} sidebarItems={sidebarItems}>
      <div className="fade-in" data-testid="admin-dashboard">
        ...
        <div className="bg-white border border-border rounded-lg p-6">
          <h2 className="text-xl font-bold text-primary mb-4">نظرة عامة</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              <div>
                <h3 className="font-bold mb-1">عرض جميع الطلبات</h3>
                <p className="text-sm text-white/80">إدارة ومتابعة الطلبات التعليمية</p>
              </div>
            ...
            >
              <div>
                <h3 className="font-bold mb-1">عرض جميع الجلسات</h3>
                <p className="text-sm text-primary/80">متابعة الجلسات التعليمية</p>
              </div>
