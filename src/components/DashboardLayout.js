...
export default function DashboardLayout({ children, user, sidebarItems }) {
  ...
  // Show back button on sub-pages (not on main dashboard pages)
  const dashboardRoots = ["/admin", "/school-admin", "/teacher", "/student"];
  const isSubPage = !dashboardRoots.includes(location.pathname);
